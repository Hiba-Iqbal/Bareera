                    ...
                    <div class="accordion-item mb-3">
                      ...
                      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          <p>This Privacy Policy (the "Privacy Policy" or the "Policy") provides our policies on the collection, storage, processing, use, and disclosure of information about users established by Gemint, Inc. ("Gemint", "we", "our" or "us") regarding the information that we collect through the website https://Gemint.com (the "Website"), through e-mail and/or other electronic communication between you and us. Before using the Website, you need to consent to our collection, use, and disclosure of information about you as described in this Policy. If you do not agree with the terms and conditions of this Privacy Policy, please do not use our Website. Minimum Required Age. The Website and our Services are not intended for use by users under 18 years of age. No one under age 18 may provide any personal information through the Website. If we learn we have collected or received personal information from a user under 18, we will delete it immediately. Information we collect.</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item mb-3">
