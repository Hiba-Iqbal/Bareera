...
const TermsAndConditions = () => {
    return (
        ...
        <div class="container">
            <div class="row">
                <h1 class="text-center">GEMINT USER AGREEMENT AND TERMS OF SERVICES</h1>
